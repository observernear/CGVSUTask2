...
- **PointManager** - управляет коллекцией контрольных точек

#### 🎨 **View** (`view/`)
- **CurveViewer** - интерфейс для отрисовки компонентов
- **Point2DViewer** - реализация отрисовки точек и кривых на Canvas

#### 📋 **Resources** (`resources/`)
- **main-view.fxml** - описание пользовательского интерфейса
